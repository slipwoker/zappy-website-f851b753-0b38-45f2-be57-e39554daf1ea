document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (isValid) {
        ...
        const successEvent = new CustomEvent('formValidated', {
          bubbles: true,
          detail: {
            form: contactForm,
  ...
  (function initRTL() {
    ...
    if (isRTL) {
      ...
      const scrollElements = document.querySelectorAll('[data-scroll-direction]');
      scrollElements.forEach(function (el) {
        const direction = el.getAttribute('data-scroll-direction');
        if (direction === 'left') {
          el.setAttribute('data-scroll-direction', 'right');
        } else if (direction === 'right') {
          el.setAttribute('data-scroll-direction', 'left');
        }
      });
    }
  })();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "GO EAST TRAVEL משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f851b753-0b38-45f2-be57-e39554daf1ea',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f851b753-0b38-45f2-be57-e39554daf1ea';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f851b753-0b38-45f2-be57-e39554daf1ea';
